...
{
    public partial class RegisterProgramCellconForm : Form
    {
        private List<ApplicationData> c_ApplicationDatas;
        public RegisterProgramCellconForm()
        {
            InitializeComponent();
            c_ApplicationDatas = new List<ApplicationData>();
        }

        private void RegisterProgramCellconForm_Load(object sender, EventArgs e)
        {
            pictureBoxRegister.Parent = pictureBox1;
            pictureBoxCancel.Parent = pictureBox1;
            labelCellconName.Parent = pictureBox1;
            labelCellconVersion.Parent = pictureBox1;
